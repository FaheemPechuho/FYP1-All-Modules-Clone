...
class Config:
    ...
    TTS_MODEL = 'melotts'  # possible values: openai, deepgram, elevenlabs, melotts, cartesia
    ...
    GROQ_LLM="llama-3.3-70b-versatile"  # Groq Llama 3.3 70B (latest model, replaces 3.1)
    OPENAI_LLM="gpt-4o"
