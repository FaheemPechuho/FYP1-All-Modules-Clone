...
def _generate_groq_response(api_key, chat_history):
    from voice_assistant.agent_actions import run_conversation
    
    client = Groq(api_key=api_key)
    
    # Use the run_conversation function from agent_actions which handles tool calls
    response_text = run_conversation(chat_history, client)
